<script lang="ts">
  ...
  let logo = "/images/eden-ui-logo.svg";
...
<header class="sticky top-0 z-40 mx-auto w-full flex-none border-b border-gray-200 bg-white dark:border-gray-600 dark:bg-gray-900">
  <Navbar color="default" fluid class="mx-auto flex w-full items-center justify-between px-4 py-1.5">
    <NavBrand href="/" class="pl-8 lg:pl-0">
      <img src={logo} class="me-3 h-8" alt="Eden UI Logo" />
      <span class="hidden self-center text-2xl font-semibold whitespace-nowrap text-gray-900 lg:block dark:text-white">Eden UI</span>
    </NavBrand>
    ...
    <div class="order-1 ml-auto flex items-center lg:order-2">
      <ToolbarLink class="hidden hover:text-gray-900 xl:inline-block dark:hover:text-white" name="View on GitHub" href="https://github.com/ao-cyber-systems/eden-ui">
        <GitHub />
      </ToolbarLink>
      <ToolbarLink class="hidden hover:text-gray-900 xl:inline-block dark:hover:text-white" name="Join community on Discord" href="https://discord.gg/aocyber">
        <Discord />
      </ToolbarLink>
    ...
    <a href="https://www.npmjs.com/package/eden-ui" class="order-4 hidden xl:block">
