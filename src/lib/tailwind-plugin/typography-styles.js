// @ts-nocheck
/**
 * Eden UI - Typography Styles
 *
 * Typography styles for the eden-typography plugin.
 * Originally extracted from flowbite-typography (fork of @tailwindcss/typography).
 *
 * This is a Tailwind v3 plugin - TypeScript checking is disabled for runtime compatibility.
 *
 * @module typography-styles
 * @license MIT
 */

// Tailwind v4 color palette (inline to avoid import compatibility issues)
const colors = {
    white: '#ffffff',
    gray: {
        50: '#f9fafb',
...
/**
 * Round a number to 7 decimal places
...
/**
 * Convert pixels to em relative to a base
 * @param {number} px - Pixel value
