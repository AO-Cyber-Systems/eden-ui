// @ts-nocheck
/**
 * Eden UI - Tailwind CSS Plugin
 *
 * Provides base styles for tooltips/popovers, forms, datatables, charts, and WYSIWYG.
 * Originally extracted from Flowbite and customized for Eden UI.
 *
 * This is a Tailwind v3 plugin - TypeScript checking is disabled for
 * compatibility with runtime usage. The file uses CommonJS and Tailwind v3 APIs.
 *
 * @module eden-plugin
 * @license MIT
 */
...
// Tailwind v4 compatible - inline theme values (previously from defaultTheme)
...
// Tailwind v4 compatible - inline color values
const colors = {
    gray: {
        50: '#f9fafb',
        100: '#f3f4f6',
...
/**
 * Eden UI Tailwind Plugin
 *
 * Note: This is a simple plugin without configurable options.
 * All features (tooltips, forms, charts, datatables, wysiwyg) are enabled by default.
 */
module.exports = plugin(function ({ addBase, addComponents, theme }) {
    // All features enabled by default in Tailwind v4 plugin format
    const tooltips = true;
    const forms = true;
    const charts = true;
    ...
    // Tooltip and popover arrow styles
    if (tooltips) {
            addBase({
        ...
        if (datatables) {
            addComponents({
                ...
                '.datatable-wrapper .datatable-search .datatable-input, .datatable-wrapper .datatable-input': {
                    ...
                    borderRadius: `${theme('borderRadius.lg', borderRadius.lg)}`,
                    backgroundColor: 'var(--color-gray-50)',
                    minWidth: '16rem',
                },
                ...
                '.datatable-wrapper .datatable-bottom .datatable-pagination .datatable-pagination-list-item:first-of-type .datatable-pagination-list-item-link::after': {
                    content: `url("${svgToDataUri(
                        `<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 24 24">
                            <path stroke="${theme('colors.gray.500', colors.gray[500])}" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m14 8-4 4 4 4"/>
                        </svg>`
                    )}")`,
                    position: 'absolute',
                    top: '50%',
                ...
                '.datatable-wrapper .datatable-bottom .datatable-pagination .datatable-pagination-list-item:first-of-type .datatable-pagination-list-item-link:hover::after': {
                    content: `url("${svgToDataUri(
                        `<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 24 24">
                            <path stroke="${theme('colors.gray.900', colors.gray[900])}" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m14 8-4 4 4 4"/>
                        </svg>`
                    )}")`,
                },
                '.dark .datatable-wrapper .datatable-bottom .datatable-pagination .datatable-pagination-list-item:first-of-type .datatable-pagination-list-item-link::after': {
                    content: `url("${svgToDataUri(
                        `<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 24 24">
                            <path stroke="${theme('colors.gray.400', colors.gray[400])}" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m14 8-4 4 4 4"/>
                        </svg>`
                    )}")`,
                },
                ...
                '.datatable-wrapper .datatable-bottom .datatable-pagination .datatable-pagination-list-item:last-of-type .datatable-pagination-list-item-link::after': {
                    content: `url("${svgToDataUri(
                        `<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 24 24">
                            <path stroke="${theme('colors.gray.500', colors.gray[500])}" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m10 16 4-4-4-4"/>
                        </svg>`
                    )}")`,
                    position: 'absolute',
                    top: '50%',
                ...
                '.datatable-wrapper .datatable-bottom .datatable-pagination .datatable-pagination-list-item:last-of-type .datatable-pagination-list-item-link:hover::after': {
                    content: `url("${svgToDataUri(
                        `<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 24 24">
                            <path stroke="${theme('colors.gray.900', colors.gray[900])}" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m10 16 4-4-4-4"/>
                        </svg>`
                    )}")`,
                },
                '.dark .datatable-wrapper .datatable-bottom .datatable-pagination .datatable-pagination-list-item:last-of-type .datatable-pagination-list-item-link::after': {
                    content: `url("${svgToDataUri(
                        `<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 24 24">
                            <path stroke="${theme('colors.gray.400', colors.gray[400])}" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m10 16 4-4-4-4"/>
                        </svg>`
                    )}")`,
                },
                ...
                '.datatable-wrapper .datatable-bottom .datatable-pagination .datatable-pagination-list-item:first-of-type .datatable-pagination-list-item-link': {
                    borderTopLeftRadius: `${theme('borderRadius.lg', borderRadius.lg)}`,
                    borderBottomLeftRadius: `${theme('borderRadius.lg', borderRadius.lg)}`,
                ...
                '.datatable-wrapper .datatable-bottom .datatable-pagination .datatable-pagination-list-item:last-of-type .datatable-pagination-list-item-link': {
                    borderTopRightRadius: `${theme('borderRadius.lg', borderRadius.lg)}`,
                    borderBottomRightRadius: `${theme('borderRadius.lg', borderRadius.lg)}`,
                    borderLeft: 0,
                },
        ...
        if (charts) {
            addComponents({
                ...
                '.apexcharts-canvas .apexcharts-tooltip .apexcharts-tooltip-title': {
                    ...
                    fontWeight: `${theme('fontWeight.normal', fontWeight.normal)} !important`,
                ...
                '.apexcharts-canvas .apexcharts-legend-text': {
                    ...
                    fontWeight: `${theme('fontWeight.medium', fontWeight.medium)} !important`,
                ...
                '.apexcharts-datalabels-group .apexcharts-text.apexcharts-datalabel-value': {
                    ...
                    fontWeight: `${theme('fontWeight.bold', fontWeight.bold)} !important`,
                },
                ...
                '.apexcharts-canvas .apexcharts-datalabels .apexcharts-text.apexcharts-pie-label': {
                    ...
                    fontWeight: `${theme('fontWeight.semibold', fontWeight.semibold)} !important`,
